...
export const INITIAL_ASSETS: Asset[] = [
  ...
  },
  {
    ...
    model: 'Hydro MPC-E 3 CRE 20-5',
    serialNumber: 'GF-2022-PMP-552',
    installDate: '2022-08-11',
    lastMaintenance: '2026-08-18',
    nextMaintenance: '2026-09-18',
    capacity: '45 m³/jam @ Head 65 meter',
    powerRating: '3 x 5.5 kW VFD Control',
    notes: 'Menyuplai air bersih untuk zona tengah lantai 8 s.d 20. Tekanan konstan di 5.2 Bar.'
  },
  {
    id: 'ast-06',
    ...
    status: 'Kritis',
    condition: 'Rusak',
    manufacturer: 'Ebara Environmental',
    model: 'EA-BioZone-200',
    serialNumber: 'EB-2021-STP-03',
    installDate: '2021-04-18',
    lastMaintenance: '2026-08-19',
    nextMaintenance: '2026-08-24',
    capacity: '200 m³/hari Pengolahan Limbah',
    powerRating: 'Blower Aerasi 15 kW + Pompa Submersible 5.5 kW',
    notes: 'Blower Aerasi Line B macet/overheat. Perlu penggantian bearing motor segera.'
  },
  {
    id: 'ast-07',
